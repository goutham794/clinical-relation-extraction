...
def Infer_NER(args):
    ...
    logging.info(f"Inference with multilingual NER model {args.model} model on {args.split} split")
...
if __name__ == "__main__":
    ...
    args.wandb_proj_name = f"Infer_NER_multilingual_Relation_Extraction"
